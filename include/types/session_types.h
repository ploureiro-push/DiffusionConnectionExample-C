...
typedef struct session_s {
        ...
        // Map of topic paths to values, used when updating binary
        // topics. This is our view of the topic values, but it may differ
        // from the current state on the server.
        HASH_T *_update_cache;
} SESSION_T;
